...
class SubscriptionServiceKafkaConsumer(BaseKafkaConsumer):
    def __init__(self, registry: SubscriptionServiceEventRegistry) -> None:
        super().__init__(
            topics=[UserServiceTopics.TOPIC],
            bootstrap_servers=settings.kafka_bootstrap_servers,
            group_id="subscription_service_group",
        )
